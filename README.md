...
- Backend health: [https://gta-sa-geoguessr-3pl5.onrender.com/api/health](https://gta-sa-geoguessr-3pl5.onrender.com/api/health)

## Notes

- This repo contains installer downloads only.
- The source project is kept separately.
- Install the launcher and use the latest Release asset when sharing the game.